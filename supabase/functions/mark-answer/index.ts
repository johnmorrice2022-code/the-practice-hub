...
- Common acceptable alternatives: N/kg = m/s2, J = N m = kg m2/s2, Pa = N/m2.

SIGNIFICANT FIGURES:
- Accept answers to 2 or 3 significant figures unless the question specifies otherwise.
- If the question says "give your answer to 2 significant figures", failure to comply loses the A mark.
...
- Equations students must recall (not on sheet): V=IR, P=IV, P=I2R, Q=It, F=ma, W=mg, v=fl, p=m/V.
...
- A bare correct answer on a 2+ mark calculation earns A mark only if the equation used is clearly implied.
...
${markingGuidance ? `SECTION 4: SUBTOPIC-SPECIFIC RULES (HIGHEST PRIORITY)\nThese override all general rules above where they conflict:\n${markingGuidance}` : ''}
